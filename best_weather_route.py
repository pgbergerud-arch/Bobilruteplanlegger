...
CANDIDATES = [
    ...
    # --- NORGE: Korridor Trondheim-Beitostølen (Oppdal/Dovre/Gudbrandsdalen/Røros/Molde) ---
    {"name": "Magalaupe Camping (Oppdal)", "lat": 62.4975, "lon": 9.5859},
    {"name": "Granmo Camping (Oppdal)", "lat": 62.5479, "lon": 9.6288},
    {"name": "Smegarden Camping (Drivdalen)", "lat": 62.5339, "lon": 9.6257},
    {"name": "Bjørkhol Camping (Dombås)", "lat": 62.0299, "lon": 9.1757},
    {"name": "Domaas Gård Hyttetun og Caravancamp (Dombås)", "lat": 62.0722, "lon": 9.1198},
    {"name": "Sæta camping (Otta)", "lat": 61.7281, "lon": 9.5444},
    {"name": "Otta Camping og Motell", "lat": 61.7722, "lon": 9.5098},
    {"name": "Vinstra Hyttetun", "lat": 61.5929, "lon": 9.7446},
    {"name": "Heggerud Gård og Camping (Sør-Fron)", "lat": 61.5759, "lon": 9.8698},
    {"name": "Kirketeigen Youth Center & Camping (Kvam)", "lat": 61.6668, "lon": 9.6933},
    {"name": "Røste Hyttetun & Camping (Os i Østerdalen)", "lat": 62.5039, "lon": 11.2608},
    {"name": "Kviltorp Camping (Molde)", "lat": 62.7424, "lon": 7.2335},
    {"name": "Furu Laksvald og Campingsenter (Sunndalsøra)", "lat": 62.6645, "lon": 8.6175},
    {"name": "Åndalsnes Camping & Motell", "lat": 62.5523, "lon": 7.7040},
    # --- NORGE: Hunderfossen / Oppland i 300 km-radius ---
    {"name": "Hunderfossen Camping", "lat": 61.2223, "lon": 10.4392},
    {"name": "Elstad Camping (Ringebu)", "lat": 61.5015, "lon": 10.1692},
    {"name": "Trabelia Hyttegrend & Camping (Venabygd)", "lat": 61.6091, "lon": 10.0694},
    {"name": "Frya Leir (Ringebu)", "lat": 61.5496, "lon": 10.0572},
    {"name": "Mageli Camping and Cabins (Tretten)", "lat": 61.3672, "lon": 10.2845},
    {"name": "Steinvik Camping AS (Moelv)", "lat": 60.9160, "lon": 10.7005},
    {"name": "Aurdal FjordCamping (Valdres)", "lat": 60.9150, "lon": 9.3940},
    {"name": "Morudstranda colony camping (Bagn)", "lat": 60.7083, "lon": 9.7156},
    # --- NORGE: Nordfjord ---
    {"name": "Nordfjordeid Marina og Bobilparkering", "lat": 61.9040, "lon": 5.9873},
    {"name": "Nesjartun Camping (Nordfjordeid)", "lat": 61.9045, "lon": 6.1262},
    {"name": "Stryn camping AS", "lat": 61.9064, "lon": 6.7242},
    {"name": "Strynsvatn camping", "lat": 61.9317, "lon": 6.9218},
    {"name": "Mindresunde Camping (Stryn)", "lat": 61.9334, "lon": 6.8865},
    {"name": "Olden Camping", "lat": 61.7390, "lon": 6.7901},
    {"name": "Tjugen Camping (Loen)", "lat": 61.8681, "lon": 6.8756},
    {"name": "Løken camping (Olden)", "lat": 61.8132, "lon": 6.8106},
    # --- NORGE: Ålesund/Molde til Trondheim (Hitra/Frøya/Orkanger/Aukra) ---
    {"name": "Hitra Camping Kurt T Heggvik", "lat": 63.5245, "lon": 9.1062},
    {"name": "Vågen Camping (Sandstad, Hitra)", "lat": 63.4789, "lon": 8.7634},
    {"name": "Orkla Camping (Orkanger)", "lat": 63.2993, "lon": 9.8357},
    {"name": "Gossen Feriesenter AS (Aukra)", "lat": 62.7788, "lon": 6.8901},
    {"name": "Sandneset Camping (Midsund)", "lat": 62.6987, "lon": 6.7001},
    # --- SVERIGE: Jämtland (øst for korridoren) ---
    {"name": "Östersunds Stugby & Camping", "lat": 63.1595, "lon": 14.6735},
    {"name": "Husbilsuppställning Storsjö Strand (Östersund)", "lat": 63.1635, "lon": 14.6440},
    # --- SVERIGE: Midtbeltet Östersund-Sundsvall-Karlstad (Dalarna/Värmland/Hälsingland) ---
    {"name": "Allstaforsens Camping (Sundsvall)", "lat": 62.3001, "lon": 17.2569},
    {"name": "Sälstens Camping (Härnösand)", "lat": 62.6446, "lon": 17.9711},
    {"name": "Uröö Ställplats (Hudiksvall)", "lat": 61.7025, "lon": 17.1802},
    {"name": "Malnbadens Camping & Hostel (Hudiksvall)", "lat": 61.7205, "lon": 17.1782},
    {"name": "Söderhamns Citycamping Ställplats", "lat": 61.3067, "lon": 17.0689},
    {"name": "Stenö Havsbad & Camping (Sandarne)", "lat": 61.2496, "lon": 17.1930},
    {"name": "Wohnmobilstellplatz (Söderhamn)", "lat": 61.3044, "lon": 17.1134},
    {"name": "Långnäs Camping (Bollnäs)", "lat": 61.3435, "lon": 16.4072},
    {"name": "Vevlingestrand Camping (Bollnäs)", "lat": 61.3477, "lon": 16.4318},
    {"name": "Lugnets camping (Falun)", "lat": 60.6196, "lon": 15.6533},
    {"name": "Brf Falun Strandby", "lat": 60.5796, "lon": 15.6734},
    {"name": "Sjösidan Falun", "lat": 60.5811, "lon": 15.6769},
    {"name": "First Camp Moraparken (Dalarna)", "lat": 61.0091, "lon": 14.5219},
    {"name": "First Camp Orsa (Dalarna)", "lat": 61.1218, "lon": 14.5992},
    {"name": "Åmåsängsgården (Mora)", "lat": 60.9821, "lon": 14.5644},
    {"name": "Caravan Club Levsnäs (Sollerön)", "lat": 60.9009, "lon": 14.5822},
    {"name": "Siljansbadets Camping (Rättvik)", "lat": 60.8887, "lon": 15.1086},
    {"name": "Enåbadets Camping (Rättvik)", "lat": 60.8904, "lon": 15.1319},
    {"name": "Leksand Resort", "lat": 60.7492, "lon": 14.9744},
    {"name": "Västanviksbadets Camping Leksand", "lat": 60.7311, "lon": 14.9529},
    {"name": "Caravan Club Tandådalen (Sälen)", "lat": 61.1792, "lon": 12.9985},
    {"name": "Stöten Sälen Camping", "lat": 61.2742, "lon": 12.8618},
    {"name": "Karlstad Swecamp Bomstadbaden", "lat": 59.3626, "lon": 13.3596},
    {"name": "Skutberget camping (Karlstad)", "lat": 59.3739, "lon": 13.3929},
    {"name": "Husbilställplats (Karlstad)", "lat": 59.3718, "lon": 13.4889},
    {"name": "First Camp Herrgårdsliv (Kristinehamn)", "lat": 59.3077, "lon": 14.0673},
    {"name": "Kristinehamns Gästhamn", "lat": 59.3109, "lon": 14.0953},
    {"name": "Revsands Familjecamping (Kristinehamn)", "lat": 59.2231, "lon": 14.0836},
    {"name": "Ingestrands Camping (Arvika)", "lat": 59.6238, "lon": 12.6072},
    {"name": "Ställplats Arvika", "lat": 59.6519, "lon": 12.5782},
    {"name": "Torsby Camping AB", "lat": 60.0915, "lon": 13.0306},
    {"name": "Värmlands Sjö och Fjäll Camping (Torsby)", "lat": 60.3055, "lon": 13.0422},
    {"name": "Camping 45 (Torsby)", "lat": 60.2756, "lon": 13.0299},
    {"name": "Munkebergs Stugor & Vandrarhem (Filipstad)", "lat": 59.7206, "lon": 14.1592},
    {"name": "Sandviken Fribad and Camping (Filipstad)", "lat": 59.7719, "lon": 14.3016},
    {"name": "Big Hill Lodge Ställplatser (Filipstad)", "lat": 59.7312, "lon": 14.1992},
    {"name": "Ljusdals Camping AB", "lat": 61.8389, "lon": 16.0411},
    {"name": "Tyllsnäs Udde AB (Borlänge)", "lat": 60.4609, "lon": 15.5212},
    {"name": "Ställplats Avesta", "lat": 60.1466, "lon": 16.1706},
    {"name": "Falkudden Camping (By Kyrkby)", "lat": 60.1814, "lon": 16.4798},
    {"name": "Horndals Bath and Camping", "lat": 60.3144, "lon": 16.4217},
    {"name": "Värmlandsgården (Hagfors)", "lat": 60.0509, "lon": 13.8647},
    {"name": "Rådastrands camping (Hagfors)", "lat": 60.0152, "lon": 13.6001},
    {"name": "Camping Djupdalen (Ekshärad)", "lat": 60.2010, "lon": 13.4961},
    ...
    # --- NORGE: Nord for Trondheim, spredt til Nord-Finnmark ---
    {"name": "Føllingstua camping (Steinkjer)", "lat": 64.1096, "lon": 11.5781},
    {"name": "Namsos Camping", "lat": 64.4747, "lon": 11.5784},
    {"name": "Torghatten Camping & Beach Restaurant (Brønnøysund)", "lat": 65.3931, "lon": 12.0990},
    {"name": "Mosheim Camping Anna Jensen (Brønnøysund)", "lat": 65.5000, "lon": 12.2569},
    {"name": "Sandnessjøen camping AS", "lat": 65.9525, "lon": 12.4620},
    {"name": "Sandnessjøen bobilcamping", "lat": 66.0199, "lon": 12.6043},
    {"name": "Bobilplass Fauske", "lat": 67.2575, "lon": 15.3848},
    {"name": "Ballangen Camping", "lat": 68.3389, "lon": 16.8577},
    {"name": "Camp 291 (Narvik)", "lat": 68.4293, "lon": 17.4443},
    {"name": "Senja Camping (Silsand)", "lat": 69.2316, "lon": 17.7027},
    {"name": "Fjordbotn camping (Senja/Botnhamn)", "lat": 69.4495, "lon": 17.8822},
    {"name": "Senja Fjordcamp / Senja by Heart (Torsken)", "lat": 69.3411, "lon": 17.1178},
    {"name": "Alta Strand Camping & Apartment", "lat": 69.9276, "lon": 23.2716},
    {"name": "Alta River Camping", "lat": 69.9296, "lon": 23.2625},
    {"name": "Camp Alta AS", "lat": 69.9277, "lon": 23.2689},
    {"name": "Storvannet NAF camping AS (Hammerfest)", "lat": 70.6593, "lon": 23.7126},
    {"name": "RV Parking (Hammerfest)", "lat": 70.6633, "lon": 23.6759},
    {"name": "Nordkapp Camping (Honningsvåg)", "lat": 71.0271, "lon": 25.8895},
    {"name": "Varanger Panorama Camping (Vadsø)", "lat": 70.0610, "lon": 29.8729},
    {"name": "Karasjok camping AS", "lat": 69.4688, "lon": 25.4890},
    # --- SVERIGE ---
    ...
    # --- DANMARK: Ekstra spredt over hele landet ---
    {"name": "Aalborg Familie Camping - Strandparken", "lat": 57.0554, "lon": 9.8856},
    {"name": "Randers City Camp", "lat": 56.4498, "lon": 9.9523},
    {"name": "Silkeborg Sø Camping & Feriehuse", "lat": 56.1705, "lon": 9.5765},
    {"name": "Terrassen Camping (Laven, Silkeborg)", "lat": 56.1243, "lon": 9.7106},
    {"name": "Herning Camping Udlejning", "lat": 56.1331, "lon": 8.9464},
    {"name": "Vejle City Camping", "lat": 55.7150, "lon": 9.5627},
    {"name": "DCU Camping Viborg", "lat": 56.4379, "lon": 9.4217},
    {"name": "Camping Thisted", "lat": 56.9525, "lon": 8.7132},
    {"name": "City Cam (Hjørring)", "lat": 57.4656, "lon": 10.0019},
    {"name": "Sønderborg Camping", "lat": 54.9012, "lon": 9.7981},
    {"name": "Sønderborg Strand Camping", "lat": 54.9357, "lon": 9.8451},
    {"name": "Camping Roskilde", "lat": 55.6738, "lon": 12.0822},
    {"name": "Helsingør Camping", "lat": 56.0433, "lon": 12.6050},
    {"name": "Enø Camping (Karrebæksminde/Næstved)", "lat": 55.1747, "lon": 11.6535},
    {"name": "Bisserup Camping Sjælland", "lat": 55.2007, "lon": 11.4967},
    {"name": "Camp Møns Klint", "lat": 54.9793, "lon": 12.5228},
    {"name": "Camping Mønbroen (Stege)", "lat": 54.9836, "lon": 12.1738},
    {"name": "Ringkøbing Camping", "lat": 56.0887, "lon": 8.3170},
    {"name": "noordwind camping galskint (Middelfart, Fyn)", "lat": 55.5169, "lon": 9.6819},
    {"name": "Klitgård Camping - Samsø", "lat": 55.9742, "lon": 10.5622},
]
